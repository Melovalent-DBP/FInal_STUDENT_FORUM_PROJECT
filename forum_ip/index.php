...
FROM topics LEFT JOIN replies ON topics.id = replies.topic_id GROUP BY(replies.topic_id)");
									...
									<div class="col-md-10">
										<div class="topic-content pull-right">
											...
											<div class="topic-info">
												<a
													href="<?php echo APPURL; ?>/categories/show.php?name=<?php echo $topic->category; ?>">
