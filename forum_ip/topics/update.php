...
if (isset($_POST['submit'])) {
    if (
        ...
        $user_image = $_SESSION['image'] ?? 'gravatar.png';

        $update = $conn->prepare("UPDATE topics SET title = :title, category =:category, body = :body, user_name = :user_name, user_image= :user_image");
